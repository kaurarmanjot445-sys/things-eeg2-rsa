...
"""
STEP 1: Extract activations from ResNet50 layers for THINGS images
===================================================================
Run this AFTER putting your THINGS images in the things_images/ folder.
This will take 1-2 hours on CPU. Just leave it running.
"""
...
def make_hook(name):
    def hook(module, input, output):
        ...
        if out.dim() == 4:   # conv layer: (B, C, H, W) → average spatial dims
